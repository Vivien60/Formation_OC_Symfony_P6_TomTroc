...
return
    ...
    <nav class="header__container nav-bar">
        ...
        <ul class="nav-bar__section nav-bar__section--list">
            <li class="nav-bar__item"><a href="?action=messagerie"><img aria-hidden="true" class="icon icon--inline-text nav-bar__icon" src="assets/img/icons/messagerie.svg"><span>Messagerie</span><span class="badge badge--inline-text nav-bar__icon nav-bar__icon--right">{$this->helper('unread_messages_count')}</span></a></li>
