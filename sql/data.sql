...
INSERT INTO book_copy (title, author, availability_status, image, description, user_id) VALUES
    ...
    ('The Kinfolk Table', 'Nathan Williams', 1, './assets/img/books/book02.jpg', 'J\'ai récemment plongé dans les pages de \'The Kinfolk Table\' et j\'ai été enchanté par cette œuvre captivante. Ce livre va bien au-delà
    ...
    ('Wabi Sabi', 'Beth Kempton', 1, './assets/img/books/book03.jpg', 'Wabi sabi (\'wah-bi sah-bi\') est un concept captivant de l\'esthétique japonaise, qui nous aide à voir la beauté dans l\'imperfection, à apprécier la
    ...
    ('Milk & Honey', 'Rupi Kaur', 1, './assets/img/books/book04.jpg', 'Recueil de poésie de l\'auteure Rupi Kaur, Milk and Honey aborde des thèmes tels que l\'amour, la douleur, la guérison et l\'émancipation. Divisé en
    ...
    ('Delight!', 'Justin Rossow', 0, './assets/img/books/book05.jpg', 'voici le voyage d\'une survie grâce à la poésie voici mes larmes, ma sueur et mon sang de vingt et un ans voici mon cœur dans tes mains voici la blessure
